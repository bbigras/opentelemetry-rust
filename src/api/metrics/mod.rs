...
pub use sync::F64ObserverResult;
...
impl Meter {
    ...
    /// TODO
    pub fn f64_value_recorder<T>(&self, name: T) -> ValueRecorderBuilder
    where
        Self: Sized,
        T: Into<String>,
    {
        ValueRecorderBuilder {
            ...
            name: name.into(),
            description: None,
            instrument_kind: InstrumentKind::ValueRecorder,
        }
    }
    ...
    pub fn new_sync_instrument(
        &self,
        name: String,
        metric_kind: InstrumentKind,
        number_kind: NumberKind,
    ) -> Box<dyn sdk_api::SyncInstrument> {
        self.core
            .new_sync_instrument(name, metric_kind, number_kind)
    }
}
...
pub struct ValueRecorder {
    instrument: Box<dyn sdk_api::SyncInstrument>,
}
...
/// TODO
#[derive(Debug)]
pub struct ValueRecorderBuilder<'a> {
    meter: &'a Meter,
    name: String,
...
impl ValueRecorderBuilder<'_> {
    ...
    /// TODO
    pub fn init(self) -> ValueRecorder {
        ValueRecorder {
            instrument: self.meter.new_sync_instrument(
                self.name,
